...
# 准备源码
curl -fLO https://ftp.gnu.org/gnu/coreutils/coreutils-9.11.tar.gz
tar -zxf coreutils-9.11.tar.gz
cd coreutils-9.11
...
# 编译 coreutils
./configure \
    --prefix=$WORKDIR/coreutils-9.11-ohos-arm64 \
...
# 进行代码签名
cd $WORKDIR/coreutils-9.11-ohos-arm64
...
cp coreutils-9.11/COPYING coreutils-9.11-ohos-arm64/
cp coreutils-9.11/AUTHORS coreutils-9.11-ohos-arm64/

# 打包最终产物
tar -zcf coreutils-9.11-ohos-arm64.tar.gz coreutils-9.11-ohos-arm64
